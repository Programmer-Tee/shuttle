...
public class Order extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BOOK YOUR SHUTTLE ");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel3.setText("PLEASE NOTE THAT WE WON'T BE AVAILABLE FROM 7 PM TO 6AM");
        ...
        jLabel5.setText("PICK UP LOCATION SHOULD BE AS CLEAR AS POSSIBLE ");
    ...
    
{
    Connection con = ShuttleDbConnection.getConnection();
     Statement st= (Statement) 
             con.createStatement();
     String insert = "INSERT INTO orders VALUES ('"+pickup+ "', '"+location+ "' )";
     st.executeUpdate(insert) ;
     System.out.print("successful entry") ;
     this.setVisible(false);
     Success home =new Success ();
